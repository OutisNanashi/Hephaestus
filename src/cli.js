...
function runInternal(argv, handlers = {}) {
  ...
  if (!KNOWN_COMMANDS.includes(command) && !reviewIngest && !mergeCommand && !notifyRender && !notifySend) throw new HephaestusError(`Unknown command: ${command}.`, "INVALID_ARGUMENT");
